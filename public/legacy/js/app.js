...
$(function () {
  ...
  const mobileMenuLinks = document.querySelectorAll("#menu a.menu__link");
...
// Color Switch Start
// --------------------------------------------- //
const themeBtns = document.querySelectorAll(".color-switcher");
...
function loadTheme(theme) {
  ...
  themeBtns.forEach((themeBtn) => {
    const icon = theme === "light" ? "ph-moon-stars" : "ph-sun";
    themeBtn.innerHTML = themeBtn.classList.contains("mobile-theme-switcher")
      ? `<span>Appearance</span><i class="ph-bold ${icon}"></i>`
      : `<em></em><i class="ph-bold ${icon}"></i>`;
  });
